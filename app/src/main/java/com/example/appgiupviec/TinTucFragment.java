 ...
 */
public class TinTucFragment extends Fragment implements getDSTinTucFromApi {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new ApiGetDSTinTuc(this).execute();
    }
    ...
    public void End(String data) {
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                arrTinTuc.add(new TinTuc(object));
            }
            adapter = new TinTucAdapter(getContext(),arrTinTuc);
